...
wget -O /var/volatile/tmp/BoHLALA_FHD.tar.gz --no-check-certificate "https://onedrive.live.com/download?cid=89E618BEC5025E42&resid=89E618BEC5025E42%211488&authkey=AJayhzMpnEN75PA"
...
if [ -f $MY_TMP_FILE ]; [ -f $MY_TMP_FILE1 ]; then
	...
	if [ $MY_RESULT -eq 0 ]; then
         echo "########################################################################"
         echo "#TeamNitro Control Center V2.0 & Skin BoHLALA_FHD INSTALLED SUCCESSFULLY #"
